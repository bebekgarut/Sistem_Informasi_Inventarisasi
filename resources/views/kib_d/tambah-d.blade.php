    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <div class="container">
                ...
                <div class="row my-2">
                    <div class="col-md">
                        <form action="{{ route('storeDataKibd') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control form-control-md" id="nibar"
                                    placeholder="Masukkan Nibar" name="nibar" value="{{ old('nibar') }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" id="spesifikasi_nama_barang"
                                    ...
                                    value="{{ old('spesifikasi_nama_barang') }}" autocomplete="off">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" id="spesifikasi_lainnya"
                                    ...
                                    value="{{ old('spesifikasi_lainnya') }}" autocomplete="off">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" id="nomor_ruas_jalan"
                                    ...
                                    value="{{ old('nomor_ruas_jalan') }}" autocomplete="off">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" id="nomor_ruas_jembatan"
                                    ...
                                    value="{{ old('nomor_ruas_jembatan') }}" autocomplete="off">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" id="nomor_ruas_jaringan_irigasi"
                                    ...
                                    value="{{ old('nomor_ruas_jaringan_irigasi') }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" id="lokasi"
                                    placeholder="Masukkan Lokasi" name="lokasi" value="{{ old('lokasi') }}"
                                    autocomplete="off">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" id="titik_koordinat"
                                    ...
                                    value="{{ old('titik_koordinat') }}" autocomplete="off">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" id="status_kepemilikan_tanah"
                                    ...
                                    value="{{ old('status_kepemilikan_tanah') }}" autocomplete="off">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" id="satuan"
                                    placeholder="Masukkan Satuan" name="satuan" value="{{ old('satuan') }}"
                                    autocomplete="off">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="number" class="add-form-control" id="harga_satuan_perolehan"
                                    ...
                                    value="{{ old('harga_satuan_perolehan') }}" autocomplete="off">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" id="cara_perolehan"
                                    ...
                                    value="{{ old('cara_perolehan') }}" autocomplete="off">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="number" class="add-form-control" id="nilai_perolehan"
                                    ...
                                    value="{{ old('nilai_perolehan') }}" autocomplete="off">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="date" class="add-form-control" id="tanggal_perolehan"
                                    ...
                                    value="{{ old('tanggal_perolehan') }}" autocomplete="off">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" id="status_penggunaan"
                                    ...
                                    value="{{ old('status_penggunaan') }}" autocomplete="off">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="DOWNLOAD" class="form-label">File(max 4 MB)</label>
                            ...
                            <hr>
                            <a href="/data_kibd" class="btn">Kembali</a>
