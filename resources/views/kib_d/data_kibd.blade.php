...
<body>
    <div class="wrapper">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <div class="container">
                <a href="/export-alld" class="download-button">
                    <i class="bi bi-download"></i> Download KIB D</a>
                <form id="filterFormd">
            ...
            <div class="container" id="kibdData" style="display: none">
                <div class="row my-2">
                    <div class="col-md">
                        <h3 class="text-center fw-bold text-uppercase">Data KIB D</h3>
                        <hr>
                    </div>
                </div>
                <div class="row my-2">
                    <div class="col-md">
                        <a href="/add-d" class="btn"><i class="fas fa-plus"></i>&nbsp;Tambah
                            Data</a>
                        <a href="/exportd" id="exportBtnc" target="_blank" class="btn"><i
                        ...
                        <table class="table table-striped text-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="fixed-width-column">Spesifikasi Nama Barang</th>
                                    <th class="fixed-width-column">Lokasi</th>
                ...
                <div class="row">
                    <div class="col-md">
                        <nav aria-label="Page navigation">
                            <ul class="pagination justify-content-center" id="paginationd">
                                <!-- pagination -->
                            </ul>
                        </nav>
                    </div>
