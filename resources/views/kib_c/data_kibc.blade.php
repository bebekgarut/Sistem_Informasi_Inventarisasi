...
<body>
    <div class="wrapper">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <div class="container">
                <a href="/export-allc" class="download-button">
                    <i class="bi bi-download"></i> Download KIB C</a>
                <form id="filterFormc">
            ...
            <div class="container" id="kibcData" style="display: none">
                <div class="row my-2">
                    <div class="col-md">
                ...
                <div class="row">
                    <div class="col-md">
                        <nav aria-label="Page navigation">
                            <ul class="pagination justify-content-center" id="paginationc">
                                <!-- pagination -->
                            </ul>
                        </nav>
                    </div>
