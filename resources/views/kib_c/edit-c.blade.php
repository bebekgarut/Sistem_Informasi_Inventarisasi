    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <div class="container">
                ...
                <div class="row my-2">
                    <div class="col-md">
                        <form action="{{ route('updateDataKibc', $kibc->id) }}" method="post"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control"
                                    placeholder="Masukan Nama Barang/Jenis Barang" id="NAMA_BARANG"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" placeholder="Bertingkat/Tidak"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" placeholder="Beton/Tidak"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" placeholder="Masukan Letak Alamat"
                                    id="LETAK_ALAMAT" value="{{ $kibc->LETAK_ALAMAT }}" name="LETAK_ALAMAT"
                                    autocomplete="off">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="date" class="add-form-control" id="TANGGAL_DOKUMEN"
                                    value="{{ $kibc->TANGGAL_DOKUMEN }}" name="TANGGAL_DOKUMEN">
                            </div>
                            <div class="mb-3">
                            ...
                            <hr>
                            <a href="{{ route('detailDataKibc', $kibc->id) }}" class="btn">Kembali</a>
