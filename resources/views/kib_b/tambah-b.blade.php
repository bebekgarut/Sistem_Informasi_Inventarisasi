    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <div class="container">
                ...
                <div class="row my-2">
                    <div class="col-md">
                        <form action="{{ route('storeDataKibb') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                            ...
                            <hr>
                            <a href="/data_kibb" class="btn">Kembali</a>
