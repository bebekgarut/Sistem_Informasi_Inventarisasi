    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <div class="container">
                ...
                <div class="row my-2">
                    <div class="col-md">
                        <form method="POST" action="{{ route('updateDataKibb', $kibb->id) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" placeholder="Masukan Nama Barang"
                                    id="NAMA_BARANG" value="{{ $kibb->NAMA_BARANG }}" name="NAMA_BARANG"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" placeholder="Masukan Nomor Register"
                                    id="NOMOR_REGISTER" value="{{ $kibb->NOMOR_REGISTER }}" name="NOMOR_REGISTER"
                                    autocomplete="off" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" placeholder="Masukan Ukuran/CC"
                                    id="UKURAN_CC" value="{{ $kibb->UKURAN_CC }}" name="UKURAN_CC" autocomplete="off">
                            </div>
                            <div class="mb-3">
                            ...
                            <hr>
                            <a href="{{ route('detailDataKibb', $kibb->id) }}" class="btn">Kembali</a>
