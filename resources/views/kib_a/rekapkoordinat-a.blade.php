    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <div class="container">
                ...
                {{ $countKoordinat }} titik koordinat
        ...
        function initialize() {
            ...
            kibas.forEach(function(kiba) {
                if (kiba.KOORDINAT) {
                    ...
                    var contentString = `
                           <h5 class="koordinat mt-0">${kiba.NAMA_BARANG}</h5>
                            <p style="color:black;"><b>${kiba.KODE_BARANG}</b></p>
                            <p style="color:black;"><b>${kiba.NOMOR_REGISTER}</b></p>
                            <p style="color:black;"><b>${kiba.PENGGUNAAN}</b></p>
