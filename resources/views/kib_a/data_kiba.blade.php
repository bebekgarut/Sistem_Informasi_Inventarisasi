...
<body>
    <div class="wrapper">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <div class="container">
                <a href="/export-all" class="download-button">
                    <i class="bi bi-download"></i> Download KIB A</a>
                <form id="filterForm">
                    <div class="mb-3">
            ...
            <div class="container" id="kibaData" style="display: none">
                <div class="row my-2">
                    <div class="col-md">
                ...
                <div class="row my-2">
                    <div class="col-md">
                        <a href="/add" class="btn"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Data</a>
                        <a href="/export" id="exportBtn" target="_blank" class="btn"><i
