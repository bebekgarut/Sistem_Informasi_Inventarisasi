                        ...
                        <form id="editForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" id="NAMA_BARANG"
                                    value="{{ $kiba->NAMA_BARANG }}" placeholder="Masukan Jenis atau Nama Barang"
                                    name="NAMA_BARANG" autocomplete="off" required>
                            </div>
                            <div class="mb-3">
                                <label for="KODE_BARANG" class="add-form-label">Kode Barang</label>
                                <input type="text" class="add-form-control" id="KODE_BARANG"
                                    value="{{ $kiba->KODE_BARANG }}" name="KODE_BARANG"
                                    placeholder="Masukan Kode Barang" autocomplete="off" required>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" id="NOMOR_REGISTER"
                                    value="{{ $kiba->NOMOR_REGISTER }}" placeholder="Masukan Nomor Register"
                                    name="NOMOR_REGISTER" autocomplete="off" required>
                            </div>
                            <div class="mb-3">
                                <label for="LUAS" class="add-form-label">Luas</label>
                                <input type="number" step="any" class="add-form-control" id="LUAS"
                                    value="{{ $kiba->LUAS }}" placeholder="Masukan Luas" name="LUAS"
                                    autocomplete="off">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="add-form-control" id="TAHUN_PENGADAAN"
                                    value="{{ $kiba->TAHUN_PENGADAAN }}" placeholder="Masukan Tahun Pengadaan"
                                    name="TAHUN_PENGADAAN" autocomplete="off">
                            </div>
                            <div class="mb-3">
                            ...
                            <hr>
                            <a href="{{ route('detailDataKiba', $kiba->id) }}" class="btn">Kembali</a>
