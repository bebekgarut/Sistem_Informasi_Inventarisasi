    ...
    <div class="wrapper">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <div class="container">
                <div class="row my-2">
                    <div class="col-md">
                        <h3 class="text-center fw-bold text-uppercase">Data KIB C</h3>
                        @if (session('success'))
                ...
                <div class="row my-2">
                    <div class="col-md">
                        <a href="{{ route('add-upb-c', ['KODE_UPB' => Auth::user()->KODE_UPB]) }}" class="btn "><i
                                class="fas fa-plus"></i>&nbsp;Tambah
                            Data</a>
                        <a href="{{ route('export-upb-c', ['KODE_UPB' => Auth::user()->KODE_UPB]) }}" target="_blank"
                    ...
                    <div class="table-responsive col-md">
                        ...
                        <table class="table table-striped text-center mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center">Tidak ada data KIB C yang tersedia.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
